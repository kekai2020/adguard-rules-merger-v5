...
> 生成时间：2026-09-23 14:49:39 | 源：18/18 | 缓存命中：18
...
|------|--------|-----------|
| 原始规则（Raw） | 3,776,497 | - |
| 去重后（精确 583,974 / 规范化 5,022 / 正则 0） | 3,187,501 | -588,996 |
| 聚合后（精确 40,056 / 通配符 2 / 升级 0） | 3,147,443 | -40,058 |
| 冲突消解后 | 3,147,242 | -33 |
...
|------|---------|---------|-------------|--------|
| HaGeZi's Threat Intelligence Feeds | 2,204,702 | 2,061,480 | 141,613 | 94% |
| HaGeZi's Gambling Blocklist | 531,612 | 525,063 | 6,516 | 99% |
| HaGeZi's Ultimate Blocklist | 283,459 | 121,652 | 160,267 | 43% |
| Phishing Army | 151,279 | 33,979 | 94,107 | 27% |
| Phishing URL Blocklist (PhishTank and OpenPhish) | 39,676 | 14,617 | 21,122 | 41% |
| HaGeZi's Encrypted DNS/VPN/TOR/Proxy Bypass | 16,472 | 14,592 | 1,610 | 90% |
| CHN: AdRules DNS List | 201,226 | 11,097 | 186,223 | 6% |
| CHN: anti-AD | 100,836 | 7,615 | 92,478 | 8% |
| AdGuard DNS filter | 181,683 | 5,104 | 174,195 | 3% |
| ShadowWhisperer's Dating List | 1,384 | 1,266 | 109 | 92% |
| Malicious URL Blocklist (URLHaus) | 3,499 | 1,046 | 1,668 | 39% |
| Stalkerware Indicators List | 934 | 446 | 61 | 88% |
| OISD Blocklist Small | 57,144 | 97 | 55,569 | 0% |
...
| CHN: anti-AD | CHN: AdRules DNS List | 86,534 | 86.5% | 43.9% |
| AdGuard DNS filter | HaGeZi's Ultimate Blocklist | 86,268 | 48.1% | 30.6% |
...
| HaGeZi's Ultimate Blocklist | OISD Blocklist Small | 55,427 | 19.7% | 99.6% |
| CHN: AdRules DNS List | OISD Blocklist Small | 52,131 | 26.4% | 93.6% |
| AdGuard DNS filter | OISD Blocklist Small | 51,532 | 28.7% | 92.6% |
| CHN: anti-AD | OISD Blocklist Small | 40,153 | 40.1% | 72.1% |
| Phishing Army | Phishing URL Blocklist (PhishTank and OpenPhish) | 20,136 | 15.7% | 56.3% |
| Phishing Army | HaGeZi's Ultimate Blocklist | 11,640 | 9.1% | 4.1% |
| Phishing URL Blocklist (PhishTank and OpenPhish) | HaGeZi's Threat Intelligence Feeds | 7,915 | 22.1% | 0.4% |
...
| HaGeZi's Threat Intelligence Feeds | OISD Blocklist Small | 1,916 | 0.1% | 3.4% |
...
| CHN: AdRules DNS List | 201,226 | 197,320 | 1.9% |
| AdGuard DNS filter | 181,683 | 179,299 | 1.3% |
| Phishing Army | 151,279 | 128,086 | 15.3% |
| CHN: anti-AD | 100,836 | 100,093 | 0.7% |
| OISD Blocklist Small | 57,144 | 55,666 | 2.6% |
| Phishing URL Blocklist (PhishTank and OpenPhish) | 39,676 | 35,739 | 9.9% |
| HaGeZi's Encrypted DNS/VPN/TOR/Proxy Bypass | 16,472 | 16,202 | 1.6% |
| Malicious URL Blocklist (URLHaus) | 3,499 | 2,714 | 22.4% |
...
| `baozhang.baidu.com` | ⚪ 未知 | 其他 | 0.00 | 检测不完整：DNS 查询失败 (timeout)，威胁情报无有效命中 | CHN: anti-AD |
...
|---------|---------|------|---------|------|
| Block 域名 | `||example.com^` | ✅ 支持 | 核心输出 | 3,147,106 |
